...
export const execContractMethod = async (name,method,callType,caller,callerPwd,params) => await fetch(`${NODE_MASTER_API}/execContractMethod`, {
  method: "POST",
  headers: {
    "Content-Type": "application/json"
  },
...
export const getBalance = async (account) => await fetch(`${NODE_MASTER_API}/getBalance`, {
  method: "POST",
  headers: {
    "Content-Type": "application/json"
  },
...
export const sendTransaction = async (sourceAccount,txPassword,distAccount,amount,data) => await fetch(`${NODE_MASTER_API}/sendTransaction`, {
  method: "POST",
  headers: {
    "Content-Type": "application/json"
  },
...
export const submitInfo = async (sourceAccount,txPassword,data) => await fetch(`${NODE_MASTER_API}/submitInfo`, {
  method: "POST",
  headers: {
    "Content-Type": "application/json"
  },
