...
export default (app: Application) => {
  ...
  router.get('/getAllContractInfo', controller.contractHandler.getAllContractInfo);
  ...
  router.post('/submitInfo', controller.contractHandler.submitInfo);
  router.post('/getBalance', controller.contractHandler.getBalance);
};
